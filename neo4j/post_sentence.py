...
def search_similiar_community(input_xiaoqu, driver, df, column_index, column_value):
...
if __name__ == '__main__':
    ...
    driver = GraphDatabase.driver('bolt://10.29.4.242:7687', auth=basic_auth("neo4j", "wsqxy8219338"))
    df = pd.read_csv('小区_newest_V3.csv', header=None, sep=',', error_bad_lines=False)
    data = search_similiar_community('望京新城',driver, df, column_index, column_value)
    print(data)